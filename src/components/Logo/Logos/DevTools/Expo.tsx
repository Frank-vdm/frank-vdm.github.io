...
export const Expo = forwardRef<SVGSVGElement, LogoProps>(
  ({ size = defaultSize, style }, ref) => {
    return (
      ...
      >
        <path
          d="M.25 8.32l2.71 1.576 13.963-8.07L14.184.25.25 8.32z"
          fill="#fff"
        />
        <path
          fill-rule="evenodd"
        ...
        />
        <path
          d="M.25 8.32v16.137l2.74 1.576-.03-16.137L.25 8.319z"
          fill="#fff"
        />
        <path
          fill-rule="evenodd"
        ...
        />
        <path
          d="M2.96 9.896l13.963-8.07v16.139L2.989 26.034 2.961 9.895z"
          fill="#000"
        />
        <path
          fill-rule="evenodd"
        ...
        />
        <path
          d="M5.048 11.081l2.71 1.577 13.962-8.07-2.738-1.576-13.934 8.07z"
          fill="#fff"
        />
        <path
          fill-rule="evenodd"
        ...
        />
        <path
          d="M7.758 12.658l13.962-8.07v16.139L7.787 28.796l-.029-16.138z"
          fill="#000"
        />
        <path
          fill-rule="evenodd"
        ...
        />
        <path
          d="M7.763 15.358l5.082 16.392 2.899-.949-5.284-16.412-2.697.969z"
          fill="#fff"
        />
        <path
          fill-rule="evenodd"
        ...
        />
        <path
          d="M21.718 7.9L26.8 24.292l2.899-.949-5.284-16.411-2.697.968z"
          fill="#fff"
        />
        <path
          fill-rule="evenodd"
        ...
        />
        <path
          d="M10.46 14.39l13.955-7.458L29.7 23.343l-13.955 7.458-5.284-16.412z"
          fill="#fff"
        />
        <path
          fill-rule="evenodd"
        ...
        />
        <path
          d="M10.46 14.39l-2.697.968L21.718 7.9l2.697-.968-13.955 7.457z"
          fill="#fff"
        />
        <path
          fill-rule="evenodd"
        ...
        />
        <path
          d="M18.395 13.053l-.941.481-.94.481-.762 11.392 1.85.827 1.41-9.114 7.375 4.623.592-2.073-8.584-6.617z"
          fill="#000"
        />
        <path
          fill-rule="evenodd"
